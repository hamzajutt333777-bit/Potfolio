  ...
  return (
    <div ref={sectionRef} className='fsn min-h-screen relative transition-all w-full pt-4 bg-blue-'>
      ...
      <div ref={skillDiv} className='relative section w-full h-[47.5vw] '>
        ...
        <div ref={skillDetail} className='translate-x-[5vw] h-[40vw] w-[70vw] bg-blue-30 flex flex-col justify-center translate-y-[1vw] p-[4vw] text-black'>
      ...
      <div ref={skillDiv2} className='relative section2 w-full h-[47.5vw] bg-transparent'>
        ...
        <div ref={skillDetail2} className='h-[40vw] w-[70vw] bg-blue-30 flex flex-col justify-center translate-y-[-1vw] p-[4vw] text-black translate-x-[5vw]'>
      ...
      <div ref={skillDiv3} className='relative section3 w-full h-[47.5vw] bg-transparent'>
        ...
        <div ref={skillDetail3} className='h-[40vw] w-[70vw] bg-blue-30 flex flex-col justify-center translate-y-[-1vw] p-[4vw] text-black translate-x-[5vw]'>
      ...
      <div ref={skillDiv4} className='relative section4 w-full h-[47.5vw] bg-transparent'>
        ...
        <div ref={skillDetail4} className='h-[40vw] w-[70vw] bg-blue-30 flex flex-col justify-center translate-y-[-1vw] p-[4vw] text-black translate-x-[5vw]'>

...
useEffect(() => {
  ...
  {projectsImageArray.map((items, index) => {
    return (
      <div key={index} className={`imagediv${index} w-full h-[38vw] flex gap-[0.7vw] mb-2 justify-center`}>
        {/* Card 1 */}
        <div
        ...
        >
          ...
          <div className="pointer-events-none opacity-0 group-hover:opacity-100 transition-all h-full w-full leading-[5vw] absolute top-0 left-0 flex flex-col items-center justify-center bg-black/80 z-20">
            ...
            {/* <div className="h-[6vw] w-[28vw] border-[0.3vw] border-white rounded-full flex items-center justify-center translate-y-[3vw]">
              <h1 className="text-white tracking-tighter font-mono  uppercase px-[3.9vw] py-[1vw] text-[3.5vw]">view project</h1>
            </div> */}
          </div>
        </div>
        ...
        >
          ...
          <div className="pointer-events-none opacity-0 group-hover:opacity-100 transition-all leading-[5vw] h-full w-full absolute top-0 left-0 flex flex-col items-center justify-center bg-black/80 z-20">
            ...
            {/* <div className="h-[6vw] w-[28vw] border-[0.3vw] border-white rounded-full flex items-center justify-center">
              <h2 className="text-white tracking-tighter font-mono uppercase px-[3.9vw] py-[1vw] text-[3.5vw]">view project</h2>
            </div> */}
          </div>
        </div>
      </div>
